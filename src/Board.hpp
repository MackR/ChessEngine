...
namespace chess {
    ...
    private:
        Piece* m_Boardstate[64]; // An array of pieces defines the board
        vector<Piece*> m_blackPieces; // vector of pointers to black pieces
        vector<Piece*> m_whitePieces; // Vector of pointers to white pieces
